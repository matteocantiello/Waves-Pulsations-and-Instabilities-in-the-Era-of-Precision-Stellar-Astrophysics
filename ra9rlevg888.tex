...
{\bf Baroclinic Instabilities} (Caltech-Princeton) This work relies heavily on analytical theory being developed by Fuller, to be extended and simulated by Leconaet. Simulation results will be packaged into analytic descriptions (e.g., equation \ref{numri}) for implementation into MESA by Fuller and 
