...
{\bf Asteroseismology with TESS/Kepler} (Caltech-UCSB-UWM-UCB) TESS will greatly increase the precision asteroseismic data available for certain types of star (e.g., massive stars, subgiants) 
