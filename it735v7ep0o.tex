...
convective, with a turnover time similar to or shorter than typical pulsation periods. To address this challenge, we will extend the GYRE code to include convection-pulsation coupling using the formalism developed by \citet{