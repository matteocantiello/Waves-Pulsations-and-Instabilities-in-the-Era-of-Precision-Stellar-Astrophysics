...
convective, with a turnover time similar to or shorter than typical pulsation periods. To address this difficulty, we will modify the GYRE code to replaceinclude convection-pulsation coupling using the formalism developed by \citet{Houdek:2010}