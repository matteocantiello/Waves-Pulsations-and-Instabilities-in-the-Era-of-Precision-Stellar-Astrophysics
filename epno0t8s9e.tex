...
GYRE was released under an open-source license in 2013, and since then has been adopted by over 50 groups worldwide as a general-purpose tool for asteroseismology. In modular form it is integrated into the MESA code, allowing on-the-fly optimization of stellar parameters (e.g., mass, composition, mixing )
