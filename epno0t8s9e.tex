...
on a spherical harmonic method in angular directions coupled with a multiple shooting technique in the radial direction, with a variety of single-step . Initial tests on
