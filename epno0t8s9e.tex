...
http://mesa.sourceforge.net/), an open source code for stellar
...
document the development progress in a series of ``instrument papers" \cite{Paxton2010,Paxton2013,Paxton2015}
(Paxton et al. 2011, 2013, 2015, 2018) that three of the investigators
...
In the most recent instrument paper (Paxton et al. 2018) a number of
