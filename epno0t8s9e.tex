...
\textbf{MESA}, Modules for Experiments in Stellar\textbf{MESA}, Modules for Experiments in Stellar
Astrophysics, solves the 1D fully coupled structure and compositionAstrophysics, solves the 1D fully coupled structure and composition
equations governing stellar evolution \cite{Paxton2010,Paxton2013,Paxton2015}. Itequations governing stellar evolution \cite{Paxton2010,Paxton2013,Paxton2015}. It
...
{\color{brown}    
\subsection{GYRE}}\subsection{GYRE}}
 \textbf{GYRE} solves the 3D linearized hydrodynamic \textbf{GYRE} solves the 3D linearized hydrodynamic
equations to calculate the nonradial, nonadiabatic oscillationequations to calculate the nonradial, nonadiabatic oscillation
