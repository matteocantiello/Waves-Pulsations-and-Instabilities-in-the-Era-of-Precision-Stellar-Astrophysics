...
on a spherical harmonic method in angular directions coupled with a multiple shooting technique in the radial direction, with a variety of single-step shooting schemes available (2$^{\rm nd}$-, $4$^{\rm Magnus). Initial tests on
