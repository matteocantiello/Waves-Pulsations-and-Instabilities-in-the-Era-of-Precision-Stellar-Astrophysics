...
will yield even larger samples of this important class of stellar pulsators, nicely complementing space-based astseismology. Additionally, SN progenitor variability can be monitored for some nearby SNe (e.g., \citealt{kochanek:17}). Comparison of variability between pre-SN RSGs and well-characterized RSGs within the local group, combined with theoretical stellar/pulsation models, will allow for a better understanding of SN progenitors.