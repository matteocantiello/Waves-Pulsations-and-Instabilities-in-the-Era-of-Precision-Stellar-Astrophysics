...
In addition to detailed asteroseismology of some targets, the combination of TESS and GAIA will dramatically iour knowledge of where stars in the HR diagram pulsate.   This zeroth order information is actually a strong constraint on stellar structure and evolution, in particular for more evolved parts of the HR diagram where whether the star pulsates depends on its previous evolutionary history, including uncertain physics such as convective overshoot.   
