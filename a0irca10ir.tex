...
One limitation of the original Kepler mission from the perspective of asteroseismology is that the modest sky coverage led to Kepler observing primarily low mass red .SPB).SPBs).  K2 alleviated this to some extent and COROT observations have also demonstrated the exciting potential asteroseismology of 
