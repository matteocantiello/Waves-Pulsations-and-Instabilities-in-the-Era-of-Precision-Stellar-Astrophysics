...
One limitation of the original Kepler mission from the perspective of asteroseismology is that the modest sky coverage led to Kepler observing primarily low mass stars, including low mass red giants and slowly pulsating B-stars (SPBsPBs).  K2 alleviated this to some extent and COROT observations have also demonstrated the exciting potential of asteroseismology in more massive stars.   In the comin 
