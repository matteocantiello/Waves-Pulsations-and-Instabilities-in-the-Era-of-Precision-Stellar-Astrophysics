...
\end{itemize}
\item Apply transport sims to specific \emph{Kepler}/\emph{K2} stars with measured mode spectra (i.e., mode parameters, amplitudes), to predict AM fluxes and see whe
