...
\item Improve GYRE to model effects of differential rotation on wave transport. First steps will just use traditional approximation, but main effort will involve using a spectral (spherical harmonic) expansion to 
