...
While Kepler did not observe many bright targets, the TESS satellite is expect to substantially increase the number of observed SPB and $\gamma$-Dor stars (SPB stars were poorly represented in the nominal Kepler mission because of the rather high Galactic latitude of the observed field).
