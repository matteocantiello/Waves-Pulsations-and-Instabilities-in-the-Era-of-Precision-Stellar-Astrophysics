...
For the first time we are in the position to reconstruct the history of internal stellar magnetism, from the main sequence to compact objects. This can be done for low and intermediate mass stars, with some of the results . 
...
and adding the effect of rotation. (Still need to extend this discussion)
