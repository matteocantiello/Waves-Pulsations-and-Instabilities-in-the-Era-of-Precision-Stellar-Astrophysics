...
we propose to extend the technique developed by our team for red giant stars, to bright main sequence stars and WDs. We will \textbf{reconstruct the history of internal stellar magnetism, from the main sequence to compact objects}
...
Kepler did not observe many SPB stars because of the rather high Galactic latitude of the observed field (What about K2?), but the TESS satellite is expect to substantially increase the number of observed SPB ($>$ 4000, Handler, Priv. Comm.) and $\gamma$-Dor stars.  
