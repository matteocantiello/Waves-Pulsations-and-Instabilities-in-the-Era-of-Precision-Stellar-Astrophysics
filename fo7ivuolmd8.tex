...
A major obstacle in determining this spectrum is different codes find drastically different wave spectra for simulations that appear to have identical parameters (Tami Rogers, private communications). \textbf{We will develop a convective wave generation benchmark problem, and ensure different codes arrive at a validated, unique solution.} We will develop a two dimensional problem in Dedalus using parameters which 
