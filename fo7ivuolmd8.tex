...
Once we have confirmed that waves found in simulations are physical, rather than numerical, we will run a series of high-resolution three-dimensional simulations specifically designed to test the 
