...
The slow rotation rates of compact objects indicates a powerful source of angular momentum transport in stars, because conservation of core angular momentum from the main sequence invariably predicts 
