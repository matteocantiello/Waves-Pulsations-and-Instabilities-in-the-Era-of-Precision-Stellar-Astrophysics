...
The spin rate of compact objects can also be affected by convectively excited IGW. In particular, stellar cores can be {\it spu- \cite{fullerwave:14} show that 
