...
The spin rate of compact objects can also be affected by waves inside thi. In particular, stellar cores can be {\it spun-up} by the  \cite{fullerwave:14} show that 
