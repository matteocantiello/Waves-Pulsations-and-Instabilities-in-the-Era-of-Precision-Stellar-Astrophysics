...
The spin rate of compact objects can also be affected by We could for instance show that $u_{rms} \sim \sqrt{N} \sim \sqrt{T}$, where $T$ is the time in the simulation.
