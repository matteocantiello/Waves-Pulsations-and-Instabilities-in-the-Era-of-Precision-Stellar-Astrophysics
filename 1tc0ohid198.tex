...
The slow rotation rates of compact objects indicates a powerful source of angular momentum transport in stars, because conservation of core angular momentum from the main sequence invariably predicts compact object rotation rates near breakup. This is consistent with asteroseismic rotation rates (\ref{fig:MRI1p8rot}) that reveal large AM
