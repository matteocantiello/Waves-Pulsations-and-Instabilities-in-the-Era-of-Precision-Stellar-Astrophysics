...
\citet{Gabriel:2014} resolved this ambiguity within local mixing length theory (the neutrality criterion must be applied on the convective side, to ensure that convective velocities vanish at the boundary). In \citet{Paxton:2017}, co-PI Townsend sdevelolved the problem for the MESA code with a new \emph{predictive mixing} scheme. This scheme adjusts the diffusivites used in 
