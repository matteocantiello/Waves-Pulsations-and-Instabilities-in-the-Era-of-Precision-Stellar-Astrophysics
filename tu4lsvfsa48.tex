...
\citet{Gabriel:2014} resolved this ambiguity by demonstrating that, within local mixing length theory, the neutrality criterion should be applied on the convective side to ensure that convective velocities vanish at the boundary. They were unable to provide a concrete approach to implementing this behavior in stellar ecodes that rely on diffusive
