...
\item during the core hydrogen-burning phase (i.e., main sequence) of massive stars, predictive mixing leads to a structure outside the convective core consisting of a semi-convection region overlaid by a thin convective shell \citep[see, e.g., the right-hand panel in Fig.~4 of][]{Paxton:2017}. Given that S
