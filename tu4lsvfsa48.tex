...
\citet{Gabriel:2014} resolved this ambiguity by demonstrating that, within local mixing length theory, the neutrality criterion should be applied on the convective side to ensure that convective velocities vanish at the boundary. Implementing this behavior in stellar evolution codes has proven non-trival, but recently Co-PI Townsend developed a new \emph{predictive mixing} schme which modifies mixing diffusivities in the c
