...
\citet{Gabriel:2014} resolved this ambiguity within local mixing length theory (the neutrality criterion must be applied on the convective side, to ensure that convective velocities vanish at the boundary). In \citet{Paxton:2017}, co-PI Townsend developed a new \emph{predictive mixing} scheme which adjusts convective diffusivites to ensure that 
