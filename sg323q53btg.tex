...
Right now, Dedalus can only run simulations in Cartesian geometry. We have developed a prototype version of Dedalus that can run simulations in spherical geometry. It uses a general strategy for solving proble geometries which include coordinate singularities. e have used to solve problems in cylindrical geometry \cite{Vasil_2016}, and spherical geometry \cite{p}
