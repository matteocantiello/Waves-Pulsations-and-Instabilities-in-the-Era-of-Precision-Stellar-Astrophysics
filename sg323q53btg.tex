...
Right now, Dedalus can only run simulations in Cartesian geometry. We have developed a prototype version of Dedalus that can run simulations in spherical geometry.  a general strategy for geometries which include coordinate singularities, which we have used to solve problems in cylindrical geometry \cite{Vasil_2016}, and spherical geometry \cite{p}
